...
$(function(){
	$('#addArticle').on('click', function() {
		location.href='<s:url value="/article/newArticle.html" />';
	});
...
<body leftmargin="8" topmargin="8" background='../../ui/images/allbg.gif'>

<!--  快速转换位置按钮  -->
<table width="98%" border="0" cellpadding="0" cellspacing="1" bgcolor="#D1DDAA" align="center">
<tr>
 <td height="26" background="<s:url value='/ui/images/newlinebg3.gif' />">
  <table width="98%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  <td align="center">
    <input id="addArticle" type='button' class="coolbg np" onClick="location='';" value='添加文档' />
...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="10" background="<s:url value='/ui/images/tbg.gif' />">&nbsp;文档列表&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>开放浏览</td>
	<td>admin</td>
	<td><a href="<s:url value='/article/edit.html' />">编辑</a> | <a href="101">预览</a></td>
</tr>
...
<table width='98%'  border='0' cellpadding='1' cellspacing='1' bgcolor='#CBD8AC' align="center" style="margin-top:8px">
  <tr bgcolor='#EEF4EA'>
    <td background="<s:url value='/ui/images/wbg.gif'/>" align='center'>
      <table border='0' cellpadding='0' cellspacing='0'>
        ...
        <td>
          <input name="imageField" type="image" src="<s:url value='/ui/images/search.gif' />" width="45" height="20" border="0" class="np" />
        </td>
       </tr>
      </table>
    </td>
